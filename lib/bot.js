...
class Bot {
    ...
    static checkMessage(message) {
        ...
        var d = "Hey all, we're currently using Discord for a while to see how it works out. Here's the link to join! https://discord.gg/kcD8DR";
        ...
        if (messageText && botRegex.test(messageText) && messageText !== d) {
